...
class AgentTokenServiceTest {
    ...
    void tokenFor_authenticatesAsTheCurrentAgentAndCachesItsToken() {
        ...
        when(apiClient.authenticate(new Think9ApiClient.Login("agent-0001", "secret-password")))
                .thenReturn(new Think9ApiClient.Token("token-for-agent-1"));
        ...
        verify(apiClient).authenticate(new Think9ApiClient.Login("agent-0001", "secret-password"));
    }
}