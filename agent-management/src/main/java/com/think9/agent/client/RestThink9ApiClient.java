...
@Component
public class RestThink9ApiClient implements Think9ApiClient {
    ...
    @Autowired
    public RestThink9ApiClient(RestClient.Builder restClientBuilder, AgentManagementProperties properties) {
        this(restClientBuilder.baseUrl(properties.getApiBaseUrl()).build());
    }

    RestThink9ApiClient(RestClient restClient) {
