...
public class AgentBootstrapService {
    ...
    @Autowired
    public AgentBootstrapService(AgentProfileRepository profileRepository, Think9ApiClient apiClient,
    ...
    AgentBootstrapService(AgentProfileRepository profileRepository, Think9ApiClient apiClient,
                          CredentialCipher credentialCipher, AgentTokenService tokenService,
