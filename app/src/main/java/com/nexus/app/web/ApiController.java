...
import com.nexus.messaging.service.MessagingService;
import com.nexus.timeline.service.TimelineService;
import com.nexus.tweets.domain.Tweet;
import com.nexus.tweets.service.TweetService;
...
public class ApiController {
    ...
    @GetMapping("/timeline/feed") List<UUID> feed(Authentication auth, @RequestParam(name = "offset", defaultValue = "0") int offset, @RequestParam(name = "limit", defaultValue = "20") int limit) { return timelineService.fetchFeed(actor(auth), offset, limit); }
